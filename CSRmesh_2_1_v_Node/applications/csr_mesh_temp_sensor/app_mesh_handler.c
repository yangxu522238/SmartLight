...
/* Device Apprearance. */
CSR_MESH_DEVICE_APPEARANCE_T appearance = {"Sensor2.1",
                                           {APPEARANCE_ORG_BLUETOOTH_SIG,
                                           APPEARANCE_CSRMESH_TEMP_SENSOR_VALUE,
                                           0x00000000}};
...
static void initializeSupportedModels(void)
{
    ...
    SensorModelHandlerInit(CSR_MESH_DEFAULT_NETID, sensor_model_groups,
        ...
        ActuatorModelHandlerInit(CSR_MESH_DEFAULT_NETID, sensor_model_groups,
                                 MAX_MODEL_GROUPS);
#endif /* ENABLE_ACTUATOR_MODEL */

#ifdef ENABLE_FIRMWARE_MODEL
        /* Initialize the firmware model */
        FirmwareModelHandlerInit(CSR_MESH_DEFAULT_NETID, NULL, 0);
