...
/* Enable Switch model support */
#define ENABLE_SWITCH_MODEL

/* Enable Watchdog model support */
...
#define DEFAULT_SCAN_DUTY_CYCLE        (50)
...
/* Enable Extesnion model support */
#define ENABLE_EXTENSION_MODEL

#if defined(ENABLE_EXTENSION_MODEL)
/* The number of Extension proposed opcode ranges the application supports. */
#define MAX_EXT_OPCODE_RANGE_SUPPORTED (2)
#endif
