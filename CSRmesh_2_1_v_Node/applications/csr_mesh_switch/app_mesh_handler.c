...
/* Device Apprearance. */
CSR_MESH_DEVICE_APPEARANCE_T appearance = {"Switch2.1",
...
static WATCHDOG_HANDLER_DATA_T          g_watchdog_handler_data;
...
{
#if defined (ENABLE_SWITCH_MODEL) || defined (ENABLE_WATCHDOG_MODEL) || \
 ...
 *
 *  DESCRIPTION
 *      This function sets the power state on the power client.
 *
 *  RETURNS
 *      Nothing.
 *
 ...
 *
 *  DESCRIPTION
 *      This function sets the light level on the light client.
 *
 *  RETURNS
 *      Nothing.
 *
