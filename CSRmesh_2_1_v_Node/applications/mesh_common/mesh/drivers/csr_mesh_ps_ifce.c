...
#endif
#ifndef CSR101x_A05
    {CSR_MESH_MCP_SEQ_DEV_COUNT_KEY, CSR_MESH_MCP_SEQ_DEV_COUNT_OFFSET},
    {CSR_MESH_MCP_SEQ_CACHE_TABLE_KEY, CSR_MESH_MCP_SEQ_CACHE_TABLE_OFFSET},
#endif
};
 ...
 *
 *  DESCRIPTION
 *      Read from Persistent Store with an offset
 *
 *  RETURNS/MODIFIES
 *      CSRmeshResult - Indicating if PS-read was successful or not
 *
 *----------------------------------------------------------------------------*/
extern CSRmeshResult CSRmeshPsReadWithOffset(CsrUint8 key, CsrUint16 offset, CsrUint16 *valueBuffer, CsrUint16 length)
{
    Nvm_Read(valueBuffer, length, getPsKeyOffset(key) + offset);
    return CSR_MESH_RESULT_SUCCESS;
}
 ...
 *
 *  DESCRIPTION
 *      Write to Persistent Store with an offset
 *
 *  RETURNS/MODIFIES
 *      CSRmeshResult - Indicating if PS-write was successful or not
 *
