 ...
 */
/*-----------------------------------------------------------------------------*/
extern CSRmeshResult CSRmeshSetSrcSequenceCache(CsrUint8 netId, 
                                                CSR_MESH_SEQ_CACHE_T *seqCache,
                                                CsrBool new_association);

/*----------------------------------------------------------------------------*
 * CSRmeshDisableSequenceCache
 */
/*! \brief CSRmeshDisableSequenceCache
 *
 *  This function disables the src,sqn cache for all the networks in mesh stack.
 *
 *  \returns Nothing
 */
/*-----------------------------------------------------------------------------*/
extern void CSRmeshDisableSequenceCache(void);
