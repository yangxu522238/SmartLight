...
#endif
    CSR_MESH_MCP_SEQ_DEV_COUNT_KEY   = 0x0D,/*!< \brief PS access key for last stored device count */
    CSR_MESH_MCP_SEQ_CACHE_TABLE_KEY = 0x0E,/*!< \brief PS access key for last stored sequence number */
...
#define CSR_MESH_MCP_SEQ_DEV_COUNT_SIZE         (1) /*!< \brief Sequence table cached device count size in words */
#define CSR_MESH_SEQ_TABLE_SIZE                 (4) /*!< \brief Sequence table size in words */
...
/*----------------------------------------------------------------------------*
 * CSRmeshPsReadWithOffset
 */
/*! \brief This function is called to read a value associated with the key
 *         from the persistant store.
 *
 *  \param key Identifier of the Persistent store parameter to be read
 *  \param offset Additional offset to be added to the offset calculated from key
 *  \param p_value Pointer to a buffer to copy the value
 *  \param length  Length of the paramter in words
 *
 *  \returns \ref CSRmeshResult
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult CSRmeshPsReadWithOffset(CsrUint8 key, CsrUint16 offset, CsrUint16 *p_value, CsrUint16 length);
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult CSRmeshPsWriteWithOffset(CsrUint8 key, CsrUint16 offset, CsrUint16 *p_value, CsrUint16 length);
