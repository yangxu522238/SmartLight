...
#define CSR_MESH_BEACON_PID     (0x1065)

/* Vendor ID for CSR */
#define APP_VENDOR_ID           (0x0A12)

/* Product ID. */
#define APP_PRODUCT_ID          (CSR_MESH_BEACON_PID)
...
#define MAX_BEACONS_SUPPORTED   (4)
...
/* This flag specifies whether the application is in beacon mode and not in 
 * proxy mode.
 */
#define APP_BEACON_MODE
